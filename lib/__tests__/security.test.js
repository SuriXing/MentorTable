...
describe('applyApiSecurity', () => {
  ...
  it('applies default rate limit when options.rateLimit is not supplied', () => {
    ...
    expect(applyApiSecurity(req, mockRes(), { maxBodyBytes: '1mb' })).toBe(true);
  });

  it('applies default rate limit when options is entirely empty', () => {
    ...
    expect(applyApiSecurity(req, mockRes(), {})).toBe(true);
  });
