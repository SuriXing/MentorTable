...
// R2A ARCH-2 fix: this map must stay in sync with public/assets/mentors/ —
// Round 2 found 23 bundled images missing from the map (orphaned files that
// shipped but never got served). Anyone adding a new file to the directory
// MUST add an entry here; the invariant is validated in a unit test.
const LOCAL_IMAGE_EXTENSIONS: Record<string, string> = {
  ...
  'hayao-miyazaki': '.jpg',
  'ikura-yoasobi': '.png',
  // Note: public/assets/mentors/intj.png and intp.png exist but are NOT
  // indexed here — MBTI codes go through buildMbtiOption which reads from
  // /assets/mbti/. The two intj/intp files in /assets/mentors/ are misplaced
  // leftovers; remove the files or move to /assets/mbti/ in a future cleanup.
  'iron-man': '.png',
  'jennie-blackpink': '.jpg',
  'jin-bts': '.png',
  'jisoo-blackpink': '.png',
  'justin-bieber': '.jpg',
  'kobe-bryant': '.jpg',
